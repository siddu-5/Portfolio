  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-400">
        My technical expertise spans Artificial Intelligence, Machine Learning,
        Full Stack Development, databases, and modern development tools that I
        use to build scalable and intelligent applications.
      </p>
